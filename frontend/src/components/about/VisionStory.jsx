...
export default function VisionStory() {
  ...
  return (
    <section className="bg-[#FDFDFD] py-12 lg:pb-8 relative overflow-hidden font-sans border-t border-gray-50">
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        <div className="mb-20 text-center max-w-3xl mx-auto">
          ...
          <p className="text-gray-400 text-sm md:text-base uppercase tracking-widest leading-relaxed font-medium">
              ...
              <div className="relative z-10 bg-white p-2 rounded-[2.5rem] shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-gray-100 overflow-hidden">
                <div className="rounded-[2rem] overflow-hidden bg-[#F7F3F0]">
                  <img
                    ...
                    className="w-full h-[350px] lg:h-[400px] object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 group-hover:scale-105"
                  />
                </div>
              </div>
