...
export default function AboutStory() {
  ...
  return (
    <section className="bg-[#FDFDFD] py-20 lg:py-13 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-0">
          ...
          <div className="w-full lg:w-[55%] z-20 animate-reveal-left">
            ...
            <div className="bg-white p-10 md:p-16 lg:pr-24 rounded-[2.5rem] rounded-br-[120px] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] border border-gray-100 relative">
              ...
              <h2 className="text-4xl md:text-5xl font-serif font-black text-[#222] leading-[1.1] mb-8">
          ...
          <div className="w-full lg:w-[55%] lg:-ml-20 relative">
            ...
            <div className="absolute -bottom-10 -left-10 w-48 h-48 md:w-64 md:h-64 rounded-[2rem] overflow-hidden border-[8px] border-white shadow-2xl z-30 hidden md:block group/small">
              <img 
            ...
            <div className="absolute top-10 -right-4 bg-[#222] text-white p-6 rounded-3xl shadow-2xl z-30 animate-bounce transition-all duration-1000 [animation-duration:4s]">
              <p className="text-[9px] font-black uppercase tracking-[0.3em] text-[#007074] mb-1">Established</p>
              <p className="text-2xl font-serif font-black italic tracking-tighter">2024</p>
              <div className="w-full h-[1px] bg-white/10 my-2" />
              <p className="text-[8px] font-bold text-gray-400 uppercase tracking-widest leading-tight">Premium <br />E-Commerce</p>
            </div>
